...
void Wireless_Telemetry(){
  ...
  if(enableWiFi==1){
    ...
    Blynk.run();  
    Blynk.virtualWrite(1,Vstupny vykon W); 
    Blynk.virtualWrite(2,Kapacita baterie);
    Blynk.virtualWrite(3,Vstupne napatie V);    
    Blynk.virtualWrite(4,Vstupny prud A);   
    Blynk.virtualWrite(5,Vystupne napatie V); 
    Blynk.virtualWrite(6,Vystupny prud A); 
    Blynk.virtualWrite(7,Teplota C); 
    Blynk.virtualWrite(8,Energia/1000); 
    Blynk.virtualWrite(9,Nabijanie);       //LED - Battery Charging Status
    Blynk.virtualWrite(10,Plne nabitie);     //LED - Full Battery Charge Status          
    Blynk.virtualWrite(11,Slaba bateria);         //LED - Low Battery Charge Status      
    Blynk.virtualWrite(12,Min napatie baterie);         
